...
figure(1);
imshow(uint8(Corr))
imwrite(uint8(Corr),strcat('corrCarrePC1Pair2Smooth',num2str(sizeWindow),'x',num2str(sizeWindow),'.png'));    
...
figure(2);
imshow(uint8(Corr))
imwrite(uint8(Corr),strcat('corrCarrePC1Pair2Smooth',num2str(sizeWindow),'x',num2str(sizeWindow),'2.png'));    
