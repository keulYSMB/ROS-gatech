     ...
     for a = 60:1:683
         for b = 60:1:1024
            if (H(a,b,radius) == 1 )%&& H(a+1,b,radius))% && H(a,b+1,radius) )&& H(a-1,b,radius) && H(a,b-1,radius))
               ...
               %  if( sqrt((im(yCenter,xCenter)-im(yCenter+10,xCenter))^2+(im(yCenter,xCenter)-im(yCenter,xCenter+10))^2)<20 );
             % if(Ig(xCenter-30,yCenter-30)<200 && Ig(xCenter-30,yCenter-20)<200 && Ig(xCenter-30,yCenter-30)<200 && Ig(xCenter-35,yCenter-35)<200 )
