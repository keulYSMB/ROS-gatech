...
class CamShiftDemo:
	...
	def detect_and_draw(self,imgmsg):
		...
		#print str(imgmsg.header)
		#self.backproject.header = imgmsg.header
		newImage = self.br.cv_to_imgmsg(self.backproject, "mono8")
		newImage.header = imgmsg.header
		#self.proba_pub.publish(self.br.cv_to_imgmsg(self.backproject, "mono8"))	
		self.proba_pub.publish(newImage)  			
		print str(newImage.header)			
