...
import tf
import threading
# Base code provided by Cedric Pradalier
# Code modified by Benjamin Cancel and Mikael Arguedas
# This code implements a simple Kalman Filter in order to detect mines and publish with certainty location of 
# markers within the RVIZ simulation.
