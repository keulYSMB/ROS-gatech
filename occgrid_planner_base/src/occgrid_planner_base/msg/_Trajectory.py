"""autogenerated by genpy from occgrid_planner_base/Trajectory.msg. Do not edit."""
import sys
...
import occgrid_planner_base.msg
import std_msgs.msg

class Trajectory(genpy.Message):
  _md5sum = "18f77ffd2d905ff0c111ac0074191f03"
  _type = "occgrid_planner_base/Trajectory"
...
"""
  __slots__ = ['header','Ts']
  _slot_types = ['std_msgs/Header','occgrid_planner_base/TrajectoryElement[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = occgrid_planner_base.msg.TrajectoryElement()
        _v9 = val1.header
        start = end
        end += 4
